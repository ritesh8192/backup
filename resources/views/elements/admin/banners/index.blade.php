            ...
            <table class="table table-bordered table-striped table-condensed cf">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-title="Full Name">{{$banner_type[$allrecord->type]}}</td>
                        ...
                        <td data-title="Action">
                            ...
                            <a href="{{ URL::to( 'admin/banners/delete/'.$allrecord->slug)}}" title="Delete" class="btn btn-danger btn-xs action-list delete-list" onclick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
                    @php $i++; @endphp
                    @endforeach
