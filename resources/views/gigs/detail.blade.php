...
"  >Remove</span>
 ...
 <div class="offer_wrap_bg__new">
                        ...
                        <ul class="nav offer-nav-tabs" role="tablist">
                            <li role="presentation"><a href="#basic" class="active" aria-controls="basic" role="tab" data-toggle="tab" onclick="updateprice('{{$recordInfo->basic_price}}', 'basic')">Basic</a></li>
