                    ...
                    <div class="management-table">
                        ...
                        @foreach($allrecords as $allrecord)
                            <div class="management-table-tr">
                                ...
                                <div class="management-table-td">{{$allrecord->Seller->first_name.' '.$allrecord->Seller->last_name}}</div>
...
<div id="info{!! $allrecord->id !!}" style="display: none;" class="frnt_div">
    <div class="nzwh-wrapper">
        <fieldset class="nzwh">
            ...
            <div class="drt">
                <div class="admin_pop"><span>Seller Name: </span>  <label>{!! $allrecord->Seller->first_name.' '.$allrecord->Seller->last_name !!}</label></div>
