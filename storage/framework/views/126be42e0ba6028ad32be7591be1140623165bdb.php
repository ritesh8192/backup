            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-12 col-md-6">
                    <div class="search_top">
                        <?php echo e(Form::open(['url' => url('gigs'), 'method' => 'post', 'class' => 'searchform1', 'id' => 'searchform1'])); ?>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav mr-auto">
                                    <li class="nav-item"><a class="nav-link" href='<?php echo e(URL::to('gigs/create')); ?>'> Post
                                            Gig</a></li>
                                    <li class="nav-item"><a class="nav-link" href='<?php echo e(URL::to('gigs')); ?>'>Browse
                                            Gigs</a></li>
                                    <?php if(session()->has('user_id')): ?>
                                        ...
                                        <li class="nav-item notification-b">
                                            <a class="nav-link" href='<?php echo e(URL::to('messages/message')); ?>'>Message <span
                                        ...
                                        <li class="nav-item"><a class="nav-link"
                                                href='<?php echo e(URL::to('logout')); ?>'>Logout</a></li>
                                    <?php else: ?>
                                        <li class="nav-item"><a class="nav-link"
                                                href='<?php echo e(URL::to('register')); ?>'>Register</a></li>
                                        <li class="nav-item"><a class="nav-link" href='<?php echo e(URL::to('login')); ?>'>
                                                Login</a></li>
                                    <?php endif; ?>
                                    ...
                                    <?php if(session()->has('user_id')): ?>
                                        ...
                                        <li class="nav-item dropdown dropdown-home">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li class=""><a
                                                        href="<?php echo e(URL::to('users/settings')); ?>">Settings</a></li>
                                                <li class=""><a class=""
                                                        href='<?php echo e(URL::to('users/dashboard')); ?>'> Dashboard</a>
                                                <li class="dropdown dropdown-home-submenu"><a class="dropdown-toggle"
                                                        href="<?php echo e(URL::to('gigs/management')); ?>">Selling</a>
                                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                        <li><a href="<?php echo e(URL::to('gigs/management')); ?>">Manage Gigs</a>
                                                        </li>
                                                        <li><a href="<?php echo e(URL::to('gigs/create')); ?>">Create New Gig</a>
                                                        </li>
                                                        <li><a href="<?php echo e(URL::to('gigs/myofferedgig')); ?>">My Offered
                                                                Gigs</a></li>
                                                    </ul>
                                                </li>
                                                <li class="dropdown dropdown-home-submenu"><a class="dropdown-toggle"
                                                        href="<?php echo e(URL::to('services/management')); ?>">Buying</a>
                                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                        <li><a href="<?php echo e(URL::to('services/management')); ?>">Manage
                                                                Requests</a></li>
                                                        <li><a href="<?php echo e(URL::to('services/create-request')); ?>">Post
                                                                Request</a></li>
                                                        <li><a href="<?php echo e(URL::to('my-saved-gigs')); ?>">My Saved Gigs</a>
                                                        </li>
                                                        <li><a href="<?php echo e(URL::to('gigs/offeredgig')); ?>">Offered
                                                                Gigs</a></li>
                                                    </ul>
                                                </li>
                                                <li class="dropdown dropdown-home-submenu"><a class="dropdown-toggle"
                                                        href="<?php echo e(URL::to('selling-orders')); ?>">Orders</a>
                                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                        <li><a href="<?php echo e(URL::to('selling-orders')); ?>">Selling
                                                                Orders</a></li>
                                                        <li><a href="<?php echo e(URL::to('buying-orders')); ?>">Buying Orders</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="dropdown dropdown-home-submenu"><a class="dropdown-toggle"
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                        ...
                                                        <li><a href="<?php echo e(URL::to('payments/history')); ?>">PayPal
                                                                History</a></li>
                                                    </ul>
                                                </li>
                                            </ul>
