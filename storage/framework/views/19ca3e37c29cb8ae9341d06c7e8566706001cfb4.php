            ...
            <div class="foot_menu block5">
                <ul>
                    <?php if($siteSettings->facebook_link): ?>
                        <li><a href="<?php echo $siteSettings->facebook_link; ?>" target="_blank"><i class="fa fa-facebook"
                                    aria-hidden="true"></i> facebook</a></li>
                    <?php endif; ?>
                    <?php if($siteSettings->twitter_link): ?>
                        <li><a href="<?php echo $siteSettings->twitter_link; ?>" target="_blank"><i class="fa fa-twitter"
...
<?php endif; ?>-->
                    <?php if($siteSettings->instagram_link): ?>
                        <li><a href="<?php echo $siteSettings->instagram_link; ?>" target="_blank"><i class="fa fa-instagram"
                                    aria-hidden="true"></i> instagram</a></li>
                    <?php endif; ?>
                    <?php if($siteSettings->linkedin_link): ?>
                        <li><a href="<?php echo $siteSettings->linkedin_link; ?>" target="_blank"><i class="fa fa-linkedin"
                                    aria-hidden="true"></i> linkedin</a></li>
                    <?php endif; ?>
                    <?php if($siteSettings->pinterest_link): ?>
                        <li><a href="<?php echo $siteSettings->pinterest_link; ?>" target="_blank"><i class="fa fa-pinterest"
                                    aria-hidden="true"></i> pinterest</a></li>
                    <?php endif; ?>
                    <?php if($siteSettings->youtube_link): ?>
                        <li><a href="<?php echo $siteSettings->youtube_link; ?>" target="_blank"><i class="fa fa-youtube"
...
<div class="footer_adat"> © Copyright @ <?php echo date('Y'); ?> &nbsp;|&nbsp; <a href="https://biznaaz.com"
...
<script>
    ...
    function restoreSystem() {
        $.ajax({
            url: "<?php echo HTTP_PATH; ?>/updatedata",
            type: "GET",
    ...
    function addtolike(gid, type) {
        $.ajax({
            url: "<?php echo HTTP_PATH; ?>/users/likeunlike",
            type: "POST",
            data: {
                'gid': gid,
                'type': type,
                ...
                success: function(result) {
                    if (result == 1) {
                        ...
                        $.each(servers, function(index, value) {
                            $("#msgcontaine").append(
                                '<li><a href="<?php echo e(HTTP_PATH); ?>/users/view-notification/' +
