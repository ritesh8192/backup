    ...
    <section class="dashboard-section">
        <div class="container">
            <div class="manage-btn">Manage Gigs
                ...
                <a href="<?php echo e(URL::to( 'gigs/create')); ?>" class="btn btn-primary">Create a new gig</a>
                <?php endif; ?>
            </div>
            ...
            <div>
                ...
                <input type="hidden" value="<?php echo e(isset($userdata)?$userdata->accept_orders:0); ?>" id="accept_orders" name="accept_orders">
                <input type="hidden" value="0" id="hide_weekend" name="hide_weekend">
                
                <div class="tab-content" id="mng_gig">
                    
                                    <?php echo $__env->make('elements.gigs.management', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
