    ...
    $(document).ready(function () {
        ...
        $("#gigform").validate({
            submitHandler: function (form) {
                ...
                var isdocsupload = $('#isdocsupload').val();
                if (isdocupload == '1') {
                    var form = $('#gigform');
                    var formdata = false;
                    if (window.FormData) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo HTTP_PATH; ?>/gigs/uploaddoc",
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
                        ...
                        success: function (data) {
                            ...
                            if(is_error == '1'){
                                ...
                                jQuery.each(data.file_name, function(key, value){
                                    if (value != undefined) {
                                        is_img = '1';
                                        $('#attachdocs').html(value);
                                    }
                                });
                                if(is_img == '1'){
                                    jQuery.each(data.json_data, function(key, value){
                                            $('#documentfiles').val(value);
                                    });
                                    document.getElementById("add_doc").value = '';
                                }
                            }
            ...
            <div class="row">
                ...
                <div class="gig_from">
                    <?php echo e(Form::model($gigDetail, ['method' => 'post', 'name' => 'gigform', 'id' => 'gigform', 'enctype' => "multipart/form-data"])); ?> 
                        ...
                        <input type="hidden" name="isdocsupload" id="isdocsupload" value="" />
                        <div class="step_form_inner step_account1" id="gig_overview">
                            ...
                            <div class="form_field">
                                ...
                                <div class="right_filed half_field">
                                    ...
                                    <?php 
                                    if($gigDetail->category_id == 143){
                                        $showCls = 'display:none;';
                                    }else{
                                        $showCls = '';
                                    }
                                    ?>
                                    <span class="drop_down_arow" id="subcategory" style="<?php echo $showCls;?>">
                            ...
                            <div class="page_btn page_btn_creat">
                                ...
                                <div class="gig_loader" id="ovw_ldr" style="display: none;" id="loaderID"><?php echo e(HTML::image("public/img/loading.gif", SITE_TITLE)); ?></div>
                            </div>
                        </div>
                        <div class="step_form_inner second_page step_account2" id="gig_package">
                            ...
                            <div class="page_btn page_btn_creat">
                                ...
                                <div class="gig_loader" id="pkg_ldr" style="display: none;" id="loaderID"><?php echo e(HTML::image("public/img/loading.gif", SITE_TITLE)); ?></div>
                            </div>
                        </div>
                        <div class="step_form_inner third_page step_account3" id="gig_description">
                            ...
                            <div class="page_btn page_btn_creat">
                                ...
                                <div class="gig_loader" id="des_ldr" style="display: none;" id="loaderID"><?php echo e(HTML::image("public/img/loading.gif", SITE_TITLE)); ?></div>
                            </div>
                        </div>
                        <div class="step_form_inner fourth_page step_account4" id="gig_requirement">
                            ...
                            <div class="page_btn page_btn_creat">
                                ...
                                <div class="gig_loader" id="req_ldr" style="display: none;" id="loaderID"><?php echo e(HTML::image("public/img/loading.gif", SITE_TITLE)); ?></div>
                            </div>
                        ...
                        <div class="step_form_inner fifth_page step_account5" id="gig_gallery">
                            ...
                            <div class="gig_video gig_pdf">
                                ...
                                <div class="gig_attach_box">
                                    ...
                                    <div class="help_text">Supported File Types: doc, docx, pdf, mp3 (Max. 2MB)</div>
                                    <div id="attachfiles">
                                        <?php  
                            ...
                            <?php if($gigDetail->category_id =='143')
                                  { $displySec = '';?>
                       <?php  } else {
                           $displySec = 'display:none;';
                       }
                           ?>
                            
                            <div class="gig_video gig_pdf" id="gig_ready_sec" style="<?php echo $displySec;?>">
                                <div class="gigtag_line">
                                    <span>Gig Ready Made Document</span>
                                    We only recommend adding a Document file if it further clarifies the service you will be providing.
                                    <span></span>
                                </div>   
                                <div class="gig_attach_box">
                                    <?php echo e(Form::file('doc_name', ['class' => 'images', 'id'=>'add_doc', 'class'=>'form-control file-item', 'accept'=>DOC_EXT])); ?>

                                    
                                    <div id="attachdocs">
                                        <?php  

                                        $attachment = array_filter(explode(',',old('document')));
                                ...
                                <?php }else{ 
                                    $attachment = array_filter(explode(',',$gigDetail->document));
                                     if(!empty($attachment)){ ?>
                                            <?php 
                                                foreach($attachment as $attachmental){
                                                    if(file_exists(GIG_DOC_FULL_UPLOAD_PATH.$attachmental) && $attachmental!=""){
                            ...
                            <div class="page_btn page_btn_creat">
                               ...
                               <!--  <input type="hidden" name="document" id="documentfiles" value="<?php echo $gigDetail->document; ?>" /> -->
                                ...
                                <div class="gig_loader" id="gal_ldr" style="display: none;" id="loaderID"><?php echo e(HTML::image("public/img/loading.gif", SITE_TITLE)); ?></div>
                            </div>
                        </div>
                        <div class="step_form_inner fifth_page step_account6" id="gig_publish">
                            ...
                            <div class="page_btn">
                                ...
                                <div class="gig_loader" id="pub_ldr" style="display: none;" id="loaderID"><?php echo e(HTML::image("public/img/loading.gif", SITE_TITLE)); ?></div>
                            </div>
                        </div>
