    ...
    <span class="navbar-toggler-icon"></span>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent2">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(URL::to('users/dashboard')); ?>">Dashboard</a></li>
                            <li class="nav-item dropdown">
                                <a href="<?php echo e(URL::to('services/management')); ?>" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Selling <b class="caret"></b></a>
                            ...
                            <li class="nav-item dropdown">
                                <a href="<?php echo e(URL::to('services/management')); ?>" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Buying <b class="caret"></b></a>
                                <ul class="dropdown-menu">
                            ...
                            <li class="nav-item dropdown">
                                <a href="<?php echo e(URL::to('buyer-requests')); ?>" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Buyer Requests <b class="caret"></b></a>
                                <ul class="dropdown-menu">
                            ...
                            <li class="nav-item dropdown">
                                <a href="<?php echo e(URL::to('selling-orders')); ?>" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Orders <b class="caret"></b></a>
                                <ul class="dropdown-menu">
                            ...
                            <li class="nav-item dropdown">
                                <a href="<?php echo e(URL::to('earnings')); ?>" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Earnings <b class="caret"></b></a>
                                <ul class="dropdown-menu">
                            ...
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(URL::to( 'users/notifications')); ?>">Notifications</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(URL::to( 'users/settings')); ?>">Settings</a></li>
                        </ul>
                    </div>
                </div>
