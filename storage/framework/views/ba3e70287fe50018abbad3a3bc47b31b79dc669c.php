...
<?php echo $__env->make('layout<div id="apus-footer" class="apus-footer footer-builder-wrapper  footer-2">
    ...
    </div>s.home', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>